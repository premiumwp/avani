...
custom-background, theme-options, custom-menu, post-formats, threaded-comments,
editor-style, featured-images, post-formats, footer-widgets

== Description ==
Welcome to Avani, a simple and minimal WordPress theme created to enhance your personal
blogging experience. It is built with cleanliness and simplicity in mind.
...
Avani WordPress Theme, Copyright 2016-2017 PremiumWP
Avani is distributed under the terms of the GNU GPL
...
Avani WordPress Theme is based on Underscores, (C) 2012-2015 Automattic, Inc.
